# Friendslop (Roblox) — MVP

Co-op survival roguelite: dia é coleta e construção, noite é defesa contra ondas.
Design completo em [docs/Friendslop_Roblox_Design_Doc_v2.md](docs/Friendslop_Roblox_Design_Doc_v2.md).
...
- `src/ServerScriptService/FriendslopServer.server.lua` — toda a autoridade (HP, recursos, spawn, dano, morte, ciclo).
- `src/StarterPlayer/StarterPlayerScripts/FriendslopClient.client.lua` — HUD + input; só envia intenção.
